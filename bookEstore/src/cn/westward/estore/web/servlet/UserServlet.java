package cn.westward.estore.web.servlet;
...
import cn.westward.estore.exception.ActiveUserException;
import cn.westward.estore.exception.LoginException;
import cn.westward.estore.exception.RegistException;
import cn.westward.estore.service.UserServiceImpl;
...
public class UserServlet extends HttpServlet {
	...
	public void regist(HttpServletRequest request, HttpServletResponse response)
		...
		request.getSession().removeAttribute("checkcode_session");//去掉session中的checkcode,防止缓存
		...
		User user = new User();
		try {
			BeanUtils.populate(user, request.getParameterMap());//利用BeanUtils.populate方法将request中的参数映射到user对象
