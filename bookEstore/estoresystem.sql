...
INSERT INTO `products` (`id`, `name`, `price`, `category`, `pnum`, `imgurl`, `description`) VALUES ('482b5255-741d-4466-8596-26b68db91dbb', 'Spring攻略', 180, '图书音像', 95, '/upload/1/1/b06c62ec-d995-4440-bee4-46cd10aab132.jpg', 'spring教程');
INSERT INTO `products` (`id`, `name`, `price`, `category`, `pnum`, `imgurl`, `description`) VALUES ('bfa6d99f-ad8e-4304-acde-7eed55520b5f', 'java编程思想', 99, '图书音响', 199, '/upload/3/6/ef6fdbf0-c1dc-45d8-bfe2-64146456de76.jpg', 'java神书');
INSERT INTO `products` (`id`, `name`, `price`, `category`, `pnum`, `imgurl`, `description`) VALUES ('fbdb8f38-c2f1-4025-a562-544cc83ad1be', 'Head First Java', 120, '图书音像', 100, '/upload/1/11/4e9cd698-8033-4e1e-87d6-4607dd2f6bc0.jpg', 'java入门经典');
INSERT INTO `products` (`id`, `name`, `price`, `category`, `pnum`, `imgurl`, `description`) VALUES ('fca76bb3-73f3-456b-8a9d-6607cd4a09a1', 'JavaWeb开发详解', 90, '服装衣帽', 200, '/upload/5/1/aa4c1502-4488-46a2-9864-33253f7c16d4.jpg', 'java web');
